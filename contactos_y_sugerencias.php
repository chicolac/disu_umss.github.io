				...
				<div id="texto_central-rfo">
					<section>
						<article>
							...
							<p>
								Puede contactarse con nosotros a la siguiente dirección:
							</p>

							<p>
								Dirección de Interacción Social Universitaria<br />
								Universidad Mayor de San Simón<br />
								Campus Universitario, Edificio Multiacadémico<br />
